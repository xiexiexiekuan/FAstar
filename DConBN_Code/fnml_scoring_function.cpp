...
scoring::fNMLScoringFunction::fNMLScoringFunction(datastructures::BayesianNetwork& network, LogLikelihoodCalculator* llc, Constraints* constraints, std::vector< std::vector< float >* >* regret) {
