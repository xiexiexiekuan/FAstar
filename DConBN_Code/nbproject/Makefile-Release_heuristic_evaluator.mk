...
CND_DLIB_EXT=so
CND_CONF=Release_heuristic_evaluator
CND_DISTDIR=dist
CND_BUILDDIR=build
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/heuristic_evaluator

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/heuristic_evaluator: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/heuristic_evaluator ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/heuristic_evaluator_main.o: heuristic_evaluator_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -I${HOME}/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/heuristic_evaluator_main.o heuristic_evaluator_main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/heuristic_evaluator
