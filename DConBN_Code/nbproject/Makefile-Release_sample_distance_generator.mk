...
CND_DLIB_EXT=so
CND_CONF=Release_sample_distance_generator
CND_DISTDIR=dist
CND_BUILDDIR=build
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sample_distance_generator

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sample_distance_generator: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sample_distance_generator ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/sample_distance_generator_main.o: sample_distance_generator_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -s -I${HOME}/local/include -MMD -MP -MF $@.d -o ${OBJECTDIR}/sample_distance_generator_main.o sample_distance_generator_main.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sample_distance_generator
